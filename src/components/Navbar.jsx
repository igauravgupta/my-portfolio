  ...
  return (
    <>
      ...
      <motion.nav
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        className="fixed top-0 left-0 w-full flex items-center justify-between px-6 py-4 bg-black/70 backdrop-blur-md border-b border-white/10 z-50 mb-15" // Added margin-bottom
      >
        {/* Logo */}
      ...
      <div className="mt-10"></div> {/* Adjust margin as needed */}
    </>
  );
}
